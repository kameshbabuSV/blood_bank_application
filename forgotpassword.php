...
<body class="login_body">
    <div class="center">
        ...
        <form action="forgotpassword_validation.php" method="post">
            <div class="txt_field">
                <span class="details">USERNAME</span>
                <input type="text" name="username" required autocomplete="off" onfocus="document.getElementById('message').style.display='none';">
            </div>
            <div class="txt_field">
                <span class="details">KEYWORD</span>
                <input type="text" name="keyword" required autocomplete="off" onfocus="document.getElementById('message').style.display='none';">
            </div>
