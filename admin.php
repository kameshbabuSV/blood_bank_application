...
<html lang="en">
   ...
   <nav class="navbar navbar-expand-md navbar-dark" style="background-color:red;">
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active">
                 <a class="nav-link" href="#">Add Camp</a>
                </li>
                <li class="nav-item">
                 <a class="nav-link" href="delete_camp.php">Delete Camp</a>
                </li>
                <li class="nav-item">
                 <a class="nav-link" href="upcomming_camps.php">Upcomming Camps</a>
                </li>
                <li class="nav-item">
                 <a class="nav-link" href="campdonors.php">Donars</a>
                </li>
                <li class="nav-item">
                 <a class="nav-link" href="donors.php">Registered Members</a>
                </li>
                <li class="nav-item">
                 <a class="nav-link" href="add_donor_page.php">Add Donor</a>
                </li>
                <li class="nav-item">
    ...
    <form class="form-signin" action="addcamp.php" method="post">
      <h1 class="h3 mb-3 font-weight-normal" style="color:red;">Add Camp</h1>
      ...
      <label for="timing" class="sr-only">Time</label>
      <input type="text" id="timing" name="timing" class="form-control" placeholder="Time" autocomplete="off" required="" onfocus="document.getElementById('message').style.display='none';">
      ...
      <?php if (isset($_GET["success"])) { ?>
                        ...
                        <?php } ?>
      <button class="btn btn-lg btn-danger btn-block" type="submit">Add Camp</button>
    </form>
